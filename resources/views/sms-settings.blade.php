                                                ...
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img  src="{{URL::asset('build/img/settings/nexmo.svg')}}" class="sms-img" alt="Profile">
                                                            </span>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img  src="{{URL::asset('build/img/settings/sms-gateway.svg')}}" class="sms-img" alt="Profile">
                                                            </span>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img src="{{URL::asset('build/img/settings/twilio.svg')}}" class="sms-img" alt="Profile">
                                                            </span>
