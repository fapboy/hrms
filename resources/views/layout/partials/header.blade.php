...
<div class="header">
    <div class="main-header">
        ...
        <div class="header-left">
            ...
            @if (!Request::is('layout-horizontal-box', 'layout-horizontal-overlay'))
                            ...
                            'calendar','email','todo','notes','social-feed','file-manager','kanban-view','invoices','invoice-details') ? 'active subdrop' : '' }}">
                                    ...
                                    <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="#" class="{{ Request::is('voice-call','video-call','outgoing-call','incoming-call','call-history') ? 'active subdrop' : '' }}">Calls<span
