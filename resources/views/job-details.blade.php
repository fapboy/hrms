...
@section('content')
    ...
    <div class="page-wrapper job-wrapper ms-0">
        ...
        <!-- Start Content -->
        <div class="breadcrumb position-relative bg-primary py-5">
            <div class="my-5"></div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-3 col-md-4">
                                <div class="d-flex align-items-center justify-content-end">
                                    <a href="#" class="btn btn-primary flex-fill me-2">Apply</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span class="badge bg-primary-transparent">Expert</span>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                                        ...
                                        <div>
                                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#apply_job">Apply Now </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
