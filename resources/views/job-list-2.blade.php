                            ...
                            <div class="d-flex right-content align-items-center flex-wrap">
                                ...
                                <div class="me-2 mb-2">
                                    <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                        <a href="{{url('job-list-2')}}" class="btn btn-icon btn-sm active bg-dark text-white me-1"><i class="ti ti-list-tree"></i></a>
                                        <a href="{{url('job-grid-2')}}" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
                                    </div>
                                </div>
